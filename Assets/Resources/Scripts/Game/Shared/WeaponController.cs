...
namespace Unity.FPS.Game
{
    ...
    public class WeaponController : MonoBehaviour
    {
        ...
        public float DelayEquepNonShoot = 0.2f;
        ...
        public float RecomendAttackRange = 50f;
        public float RecomendStopAttackRange = 10f;
        ...
        [Tooltip("Refernces of the muzzle flash")]
        ...
        public PlayerSaves PlayerSettings => m_SettingsManager.CurrentPlayerSaves;
        ...
        public void SetOptions(int index, PlayerController playerController)
        {
            ...
            m_SettingsManager = playerController.LoadManager.SettingsManager;
            m_PlayerController = playerController;
            MatchSettings = m_SettingsManager.CurrentMatchSaves;
            PlayerWeaponsManager = playerController.LoadManager.PlayerWeaponsManager;
        }
        public void SetOptions(int index, EnemyController enemyController)
        {
            IndexWeaponList = index;

            m_SettingsManager = enemyController.LoadManager.SettingsManager;
        ...
        public void ShowWeapon(bool show)
        {
            ...
            {
                StartCoroutine(WaitWeaponActive());
            }
        }

        private IEnumerator WaitWeaponActive()
        {
            yield return new WaitForSeconds(DelayEquepNonShoot);
            IsWeaponActive = true;
        }
        ...
        {
            if (m_CurrentBullets < 1f) ShootAudioSource.PlayOneShot(EmptyMagazinSfx);
