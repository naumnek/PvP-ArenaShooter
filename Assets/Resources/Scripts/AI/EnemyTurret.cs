    ...
    public class EnemyTurret : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            m_RotationWeaponForwardToPivot =
                Quaternion.Inverse(m_EnemyController.activeWeapon.WeaponGunMuzzle.rotation) * TurretPivot.rotation;
            ...
            switch (AiState)
            {
                case AIState.Attack:
                    ...
                    Vector3 directionToTarget =
                        (KnownDetectedTarget.transform.position - TurretAimPoint.position).normalized;
